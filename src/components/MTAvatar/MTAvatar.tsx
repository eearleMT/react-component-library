...
export const MTAvatar: React.FC<AvatarProps> = ({ image, useGroupIcon = false, imageTitle = '', size = 'md', color = 'primary' }) => {
    ...
    const className = `mt-avatar size-${size} color-${color}`;
    ...
    if (image) {
        ...
        return (
            <div className={className}>
                <img src="/group.svg" alt="Group Icon" style={{ width: '100%', height: '100%' }} />
            </div>
        );
    } else {
        return (
